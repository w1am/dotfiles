...
_G.packer_plugins = {
  ...
  ["barbar.nvim"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/barbar.nvim"
  },
  ["coc.nvim"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/coc.nvim"
  },
  gruvbox = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/gruvbox"
  },
  ["nvim-colorizer.lua"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/nvim-colorizer.lua"
  },
  ["nvim-tree.lua"] = {
    loaded = true,
  ...
  tcomment_vim = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/tcomment_vim"
  },
  ["telescope-fzy-native.nvim"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/telescope-fzy-native.nvim"
  },
  ["telescope.nvim"] = {
    loaded = true,
  ...
  ["vim-signify"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/vim-signify"
  },
  ["vim-snippets"] = {
    loaded = true,
    path = "/home/will/.local/share/nvim/site/pack/packer/start/vim-snippets"
  }
}
